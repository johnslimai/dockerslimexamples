...
Layer 1 contains files associated with node.js. It is the largest layer (56.8MB) and contains largest single file usr/local/bin/node (36.4MB). This file is the node.js execuatble binary image.
